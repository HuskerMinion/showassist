...
class APPConfig @Inject constructor(val context: Context) {
    ...
    */
    ...
    companion object {
        ...
        const val GITHUB_API_URL = "https://api.github.com/repos/HuskerMinion/showassist/releases"
        const val GITHUB_RELEASES_URL = "https://github.com/HuskerMinion/showassist/releases"
    }
}
